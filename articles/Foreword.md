...
其实，这样子感觉也是不错的，这样子不需要理会什么操作系统了（其实有时候还是需要考虑的，毕竟要安装Chrome），只要安装了Chrome，然后安装了Google Input Tools for Chrome，登录GitHub帐号@icecream或者@creamidea，使用Markdown语言来写（本来想使用Emacs的Org，但是最终还是选择了Markdown。为何？），一切都是自己熟悉的环境。
